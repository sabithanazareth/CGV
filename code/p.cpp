...
void init(void)
{
  // glClearColor(0.556863,0.137255,0.419608,1.0);//dark purple
    glClearColor(0.137255,0.137255,0.556863,1.0);//navy blue
   // glClearColor(0.439216,0.858824,0.858824,1.0);//cyan
     //glClearColor(0.439216,0.858824,0.576471,1.0);//aquamarine
   //glClearColor(0.858824,0.439216,0.576471,1.0);//violet red
